...
public record WCKeyEvent(int type, String text, String keyIdentifier, int windowsVirtualKeyCode,
        boolean shiftDown, boolean ctrlDown, boolean altDown, boolean metaDown, long when) {
