...
public record WCMouseWheelEvent(int x, int y, int screenX, int screenY, long when,
        boolean shiftDown, boolean controlDown, boolean altDown, boolean metaDown, float deltaX, float deltaY){}