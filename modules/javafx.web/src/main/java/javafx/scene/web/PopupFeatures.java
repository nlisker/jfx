...
public record PopupFeatures(@NamedArg("menu") boolean hasMenu, @NamedArg("status") boolean hasStatus,
        @NamedArg("toolbar") boolean hasToolbar, @NamedArg("resizable") boolean isResizable) {}
