...
/**
 * A base class containing common implementation code for many of the {@code StringConverter} implementations in this
 * package.
 */
abstract class BaseStringConverter<T> extends StringConverter<T> {
    ...
    /**
     * Returns a string from a non-{@code null} reference.
     * <p>
     * Treat as protected (implementing classes are public so they can't add a new protected method).
     */
